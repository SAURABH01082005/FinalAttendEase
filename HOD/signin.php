...
if($_SERVER['REQUEST_METHOD']=='POST'){
    ...
    $sql="SELECT * FROM `hod-login` WHERE `name`='$name' AND `password`='$password'";
...
<body>
  ...
  <a href="#" id="contact">Contact</a> -->
    ...
    <main>
    <h1 class="secondhead">HOD Login</h1>
    <div class="container">
