...
<head>
  ...
  <link rel="stylesheet" href="HOD_front2.css">
  <!-- bootstrap script -->
        ...
        <nav class="navbar navbar-expand-lg navbar-dark">
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav ms-auto">
              ...
              <li class="nav-item">
                <a class="nav-link"  id="nav-link" href="">Faculty Attendence</a>
              </li>
              <li class="nav-item">
                <a class="nav-link" id="nav-link" href="addstudent.php">Add Student</a>
              </li>
              <!-- <li class="nav-item">
        ...
        <div class="row">
          ...
          <div class="col-md-6 col-12">
            ...
            if(isset($_SESSION['HOD_username'])){
              $name=strtoupper($_SESSION['HOD_username']);
              $space="    ";
              ?>
