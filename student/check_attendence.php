...
<link href="https://fonts.googleapis.com/css2?family=Nunito+Sans:ital,opsz,wght@0,6..12,200..1000;1,6..12,200..1000&display=swap" rel="stylesheet">
    ...
    <link rel="stylesheet" href="check_attendence3.css">
</head>
<body>
<header>
        <h1>AttendEase</h1>
  ...
  <a href="#" id="contact">Contact</a> -->
     ...
     <?php 
            ...
            $holiday_chart=0;
            $null_chart=0;
            if(isset($_SESSION['student_username']) && isset($_SESSION['student_userid']) ){
              $name=strtoupper($_SESSION['student_username']);
              $student_id=$_SESSION['student_userid'];
              $space="    ";
              ?>
            <H4 ><pre style=" font-size:23.4327px ;font-family: 'quicksand';font-weight: 500; margin-top: 20px;font-weight:900;">WELCOME      <?php  echo "$name"?></pre></H4>
              <?php
            }
            ?>
