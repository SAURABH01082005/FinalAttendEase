...
<link href="https://fonts.googleapis.com/css2?family=Nunito+Sans:ital,opsz,wght@0,6..12,200..1000;1,6..12,200..1000&display=swap" rel="stylesheet">
    <title>Check_Attendence</title>
    <link rel="stylesheet" href="check_attendence.css">
</head>
<body>
<header>
        <h1>AttendEase</h1>
...
$result=mysqli_query($conn, "SELECT * FROM student_info WHERE ") or die(mysqli_error($conn));
