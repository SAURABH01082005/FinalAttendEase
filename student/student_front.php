...
<head>
  ...
  <link rel="stylesheet" href="student_front3.css">
  <!-- bootstrap script -->
        ...
        <nav class="navbar navbar-expand-lg navbar-dark">
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <li class="nav-item">
              ...
              <li class="nav-item">
                <a class="nav-link"  id="nav-link" href="check_attendence.php">Attendance</a>
              </li>
              <li class="nav-item">
                <a class="nav-link" id="nav-link" href="https://localhost/miniprojectattendenceSem3/student/teachingplan.php">Syllabus</a>
              </li>
              
              <li class="nav-item">
                <a class="nav-link" id="nav-link" href="">Feedback</a>
              </li>
